  ...
  return (
    <div>
      <div style={{ marginBottom: 24 }}>
        <h2 style={{ fontSize: 22, fontWeight: 700, letterSpacing: '0.12em', lineHeight: 1, marginBottom: 6 }}>地图统计</h2>
          ...
          return (
            <div
              ...
              style={{
                ...
                boxShadow: `inset 5px 0 24px ${winColor}18`,
                alignItems: 'center',
              }}
            >
              <span style={{ fontSize: 14, fontWeight: 700, letterSpacing: '0.04em' }}>{mapName(s.map_name)}</span>
